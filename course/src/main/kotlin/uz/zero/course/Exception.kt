...
class CoursePriceInvalidException() : UserServiceException() {
    override fun errorType() = ErrorCode.PRICE_INVALID
}

class CourseNotFoundException() : UserServiceException() {
